...
if [ "$NOTARIZE" ]; then
  electron-osx-sign Aedge-darwin-x64/Aedge.app --platform=darwin \
...
mv Aedge-darwin-x64 ../build_scripts/dist/
cd ../build_scripts || exit

DMG_NAME="Aedge-$AEDGE_INSTALLER_VERSION.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Aedge-darwin-x64/Aedge.app Aedge-$AEDGE_INSTALLER_VERSION \
