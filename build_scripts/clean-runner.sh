...
rm -rf ../venv || true
rm -rf venv || true
rm -rf aedge_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf aedge-blockchain-gui/build || true
rm -rf aedge-blockchain-gui/daemon || true
rm -rf aedge-blockchain-gui/node_modules || true
rm aedge-blockchain-gui/temp.json || true
( cd "$PWD/aedge-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
...
npm uninstall -g @aedgecoin/notarize-cli || true
