...
from aedge.cmds.init_funcs import aedge_full_version_str
from aedge.protocols.protocol_message_types import ProtocolMessageTypes
from aedge.protocols.protocol_state_machine import message_response_ok
from aedge.protocols.protocol_timing import INTERNAL_PROTOCOL_ERROR_BAN_SECONDS
from aedge.protocols.shared_protocol import Capability, Handshake
...
from aedge.util.ints import uint8, uint16

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from aedge.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSAedgeConnection:
    """
