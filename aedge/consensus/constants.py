...
class ConsensusConstants:
    ...
    # We override this value based on the chain being run (testnet, testnet, mainnet, etc)
    GENESIS_CHALLENGE: bytes32
    # Forks of aedge should change this value to provide replay attack protection
    ...
    # Max coin amount uint(1 << 64). This allows coin amounts to fit in 64 bits. This is around 18M aedge.
    MAX_COIN_AMOUNT: int
