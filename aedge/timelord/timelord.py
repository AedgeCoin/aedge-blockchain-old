...
from aedge.consensus.pot_iterations import calculate_sp_iters, is_overflow_block
...
from aedge.timelord.iters_from_block import iters_from_block
from aedge.timelord.timelord_state import LastState
from aedge.timelord.types import Chain, IterationType, StateType
from aedge.types.blockchain_format.classgroup import ClassgroupElement
from aedge.types.blockchain_format.reward_chain_block import RewardChainBlock
...
class Timelord:
    def __init__(self, root_path, config: Dict, constants: ConsensusConstants):
        ...
        self.server: Optional[AedgeServer] = None
    ...
    async def _handle_failures(self):
        ...
        if time.time() - self.vdf_failure_time < self.constants.SUB_SLOT_TIME_TARGET * 3:
            ...
            # If there were no failures recently trigger a reset after 600 seconds of no activity.
