...
from aedge.full_node.mempool_check_conditions import mempool_check_conditions_dict, get_name_puzzle_conditions
...
from aedge.util.clvm import int_from_bytes
from aedge.util.condition_tools import (
    pkm_pairs_for_conditions_dict,
)
from aedge.util.errors import Err
from aedge.util.generator_tools import additions_for_npc
...
class MempoolManager:
    def __init__(self, coin_store: CoinStore, consensus_constants: ConsensusConstants):
        ...
        # transactions. This prevents spam. This is equivalent to 0.055 AEC per block, or about 0.00005 AEC for two
        # spends.
