...
from aedge.consensus.block_rewards import calculate_base_farmer_reward
from aedge.pools.pool_wallet import PoolWallet
from aedge.pools.pool_wallet_info import create_pool_state, FARMING_TO_POOL, PoolWalletInfo, PoolState
from aedge.protocols.protocol_message_types import ProtocolMessageTypes
from aedge.server.outbound_message import NodeType, make_msg
from aedge.simulator.simulator_protocol import FarmNewBlockProtocol
from aedge.types.blockchain_format.coin import Coin
from aedge.types.blockchain_format.sized_bytes import bytes32
from aedge.util.bech32m import decode_puzzle_hash, encode_puzzle_hash
from aedge.util.byte_types import hexstr_to_bytes
from aedge.util.ints import uint32, uint64
from aedge.util.keychain import KeyringIsLocked, bytes_to_mnemonic, generate_mnemonic
from aedge.util.path import path_from_root
from aedge.util.ws_message import WsRpcMessage, create_payload_dict
from aedge.wallet.cc_wallet.cc_wallet import CCWallet
from aedge.wallet.derive_keys import master_sk_to_singleton_owner_sk
from aedge.wallet.rl_wallet.rl_wallet import RLWallet
from aedge.wallet.derive_keys import master_sk_to_farmer_sk, master_sk_to_pool_sk, master_sk_to_wallet_sk
from aedge.wallet.did_wallet.did_wallet import DIDWallet
from aedge.wallet.trade_record import TradeRecord
from aedge.wallet.transaction_record import TransactionRecord
from aedge.wallet.util.backup_utils import download_backup, get_backup_info, upload_backup
from aedge.wallet.util.trade_utils import trade_record_to_dict
from aedge.wallet.util.transaction_type import TransactionType
from aedge.wallet.util.wallet_types import WalletType
from aedge.wallet.wallet_info import WalletInfo
from aedge.wallet.wallet_node import WalletNode
from aedge.util.config import load_config
...
class WalletRpcApi:
    def __init__(self, wallet_node: WalletNode):
        ...
        self.service_name = "aedge_wallet"
    ...
    async def _state_changed(self, *args) -> List[WsRpcMessage]:
        ...
        return [create_payload_dict("state_changed", data, "aedge_wallet", "wallet_ui")]
    ...
    async def _check_key_used_for_rewards(
        ...
        farmer_target = config["farmer"].get("aec_target_address")
        pool_target = config["pool"].get("aec_target_address")
        found_farmer = False
        found_pool = False
    ...
    async def create_new_wallet(self, request: Dict):
        ...
        if request["wallet_type"] == "cc_wallet":
            ...
            if request["mode"] == "new":
                ...
                from aedge.pools.pool_wallet_info import initial_pool_state_from_dict
