...
from aedge.harvester.harvester import Harvester
from aedge.plotting.util import PlotInfo, parse_plot_info
from aedge.protocols import harvester_protocol
from aedge.protocols.farmer_protocol import FarmingInfo
from aedge.protocols.harvester_protocol import Plot
from aedge.protocols.protocol_message_types import ProtocolMessageTypes
from aedge.server.outbound_message import make_msg
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSAedgeConnection
    ):
        """
