...
from aedge.consensus.network_type import NetworkType
from aedge.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from aedge.farmer.farmer import Farmer
from aedge.protocols import farmer_protocol, harvester_protocol
from aedge.protocols.harvester_protocol import PoolDifficulty
...
from aedge.util.api_decorators import api_request, peer_required
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSAedgeConnection
    ):
        """
