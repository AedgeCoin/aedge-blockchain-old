...
from aedge.consensus.cost_calculator import calculate_cost_of_program, NPCResult
from aedge.full_node.bundle_tools import simple_solution_generator
...
from aedge.types.announcement import Announcement
...
from aedge.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import (
    DEFAULT_HIDDEN_PUZZLE_HASH,
    calculate_synthetic_secret_key,
    puzzle_for_pk,
    solution_for_conditions,
)
from aedge.wallet.puzzles.puzzle_utils import (
...
from aedge.wallet.secret_key_store import SecretKeyStore
from aedge.wallet.sign_coin_spends import sign_coin_spends
...
class Wallet:
    ...
    async def create_spend_bundle_relative_aedge(self, aedge_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if aedge_amount < 0:
            utxos = await self.select_coins(abs(aedge_amount), exclude)
        else:
        ...
        aedge_amount = spend_value + aedge_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": aedge_amount}]
