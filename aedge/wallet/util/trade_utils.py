...
from aedge.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "aedge" in cc_discrepancies:
                    cc_discrepancies["aedge"] = cc_discrepancies["aedge"] + diff
                else:
                    cc_discrepancies["aedge"] = diff
