...
# /install.sh _AedgeFork
# Check for non 64 bit ARM64/Raspberry Pi installs
if [ "$(uname -m)" = "armv7l" ]; then
  echo ""
	echo "WARNING:"
	echo "The Aedge Blockchain requires a 64 bit OS and this is 32 bit armv7l"
	echo "Exiting."
	exit 1
fi
# Get submodules
...
# /install.sh _AedgeFork
echo ""
echo "Aedge blockchain install.sh complete."
echo ""
echo "To install the GUI type 'sh install-gui.sh' after '. ./activate'."
echo ""
echo "Type '. ./activate' and then 'aedge init' to begin."
