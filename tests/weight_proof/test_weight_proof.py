...
from aedge.server.start_full_node import SERVICE_NAME
...
from aedge.consensus.pot_iterations import calculate_iterations_quality
from aedge.full_node.weight_proof import (  # type: ignore
    WeightProofHandler,
