...
from aedge.pools.pool_config import PoolWalletConfig
from aedge.util.config import load_config, save_config, create_default_aedge_config
...
def test_pool_config():
    ...
    create_default_aedge_config(test_root, ["config.yaml"])
