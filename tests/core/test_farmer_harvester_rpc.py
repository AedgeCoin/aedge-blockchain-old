...
from aedge.plotting.util import stream_plot_info_ph, stream_plot_info_pk, PlotRefreshResult
from aedge.plotting.manager import PlotManager
from aedge.protocols import farmer_protocol
from aedge.rpc.farmer_rpc_api import FarmerRpcApi
from aedge.rpc.farmer_rpc_client import FarmerRpcClient
from aedge.rpc.harvester_rpc_api import HarvesterRpcApi
from aedge.rpc.harvester_rpc_client import HarvesterRpcClient
...
from aedge.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_pooling_authentication_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "aec"), encode_puzzle_hash(new_ph_2, "aec"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "aec"))
            ...
            assert config["farmer"]["aec_target_address"] == encode_puzzle_hash(new_ph, "aec")
            assert config["pool"]["aec_target_address"] == encode_puzzle_hash(new_ph_3, "aec")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "aec")
