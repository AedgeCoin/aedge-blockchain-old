...
from aedge.types.blockchain_format.program import Program, SerializedProgram

wallet_program_files = set(
    [
        "aedge/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "aedge/wallet/puzzles/cc.clvm",
        "aedge/wallet/puzzles/chialisp_deserialisation.clvm",
        "aedge/wallet/puzzles/rom_bootstrap_generator.clvm",
        "aedge/wallet/puzzles/generator_for_single_coin.clvm",
        "aedge/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "aedge/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "aedge/wallet/puzzles/lock.inner.puzzle.clvm",
        "aedge/wallet/puzzles/p2_conditions.clvm",
        "aedge/wallet/puzzles/p2_delegated_conditions.clvm",
        "aedge/wallet/puzzles/p2_delegated_puzzle.clvm",
        "aedge/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "aedge/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "aedge/wallet/puzzles/p2_puzzle_hash.clvm",
        "aedge/wallet/puzzles/rl_aggregation.clvm",
        "aedge/wallet/puzzles/rl.clvm",
        "aedge/wallet/puzzles/sha256tree_module.clvm",
        "aedge/wallet/puzzles/singleton_top_layer.clvm",
        "aedge/wallet/puzzles/did_innerpuz.clvm",
        "aedge/wallet/puzzles/decompress_puzzle.clvm",
        "aedge/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "aedge/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "aedge/wallet/puzzles/block_program_zero.clvm",
        "aedge/wallet/puzzles/test_generator_deserialize.clvm",
        "aedge/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "aedge/wallet/puzzles/p2_singleton.clvm",
        "aedge/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "aedge/wallet/puzzles/pool_member_innerpuz.clvm",
        "aedge/wallet/puzzles/singleton_launcher.clvm",
        "aedge/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
    ]
)

clvm_include_files = set(
    ["aedge/wallet/puzzles/create-lock-puzzlehash.clvm", "aedge/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "aedge/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to aedge/wallet/puzzles, but not added to `wallet_program_files`
        """
